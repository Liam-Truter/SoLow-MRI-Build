...
def get_valid_points(x, y, z, r, clearance=5, spacing=1):
    ...
    X = x#np.arange(x, opentrons_x_range[1], 1)[::spacing]
...
valid_points = get_valid_points(points[0,0],fitted_center_y, fitted_center_z, fitted_radius, clearance=10, spacing=1)
